        ...
        <div class="card pe-4" style="height: 300px">
          <div class="card-body">
            ...
            <div class="mt-4">
              ...
              />
              <div class="mt4">
                <label for="searchPhoneNumberByHolidayId" class="mb-2 form-label"
                  >Search by Holiday ID:</label
                >
                <input
                  type="text"
                  class="form-control mb-5"
                  id="searchPhoneNumberByHolidayId"
                  v-model="searchPhoneNumberByHolidayId"
                />
              </div>
            </div>
...
const searchPhoneNumberByHolidayId = ref("");
...
const findReservation = () => {
  const reservation = holidayStore.findReservationByPhoneNumber || holidayStore.findReservationByHolidayId(
    searchPhoneNumber.value,
      searchPhoneNumberByHolidayId.value
  );
